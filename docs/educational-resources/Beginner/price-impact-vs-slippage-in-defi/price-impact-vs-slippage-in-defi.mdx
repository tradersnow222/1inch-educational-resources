...
**_Price slippage_** refers to the change in price caused by external broad market movements (unrelated to your trade), while **_price impact_** refers to the change in price directly caused by your own trade itself.
